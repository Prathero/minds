 ...
 */
	...
	'loginerror' => "Incapaz de logar. Verifique suas credenciais e tente novamente.",
	'login:empty' => "Nome de usuário e senha são necessários.",
	'login:baduser' => "Incapaz de carregar sua conta.",
	'auth:nopams' => "Erro interno. Sem método de autenticação de usuário instalado.",

	'logout' => "Sair",
	'logoutok' => "Você saiu com sucesso.",
	'logouterror' => "Incapaz de sair. Tente novamente.",

	'loggedinrequired' => "Você precisa estar logado para ver essa página.",
	'adminrequired' => "Você precisa ser um administrador para ver essa página.",
	'membershiprequired' => "Você precisa ser um membro desse grupo para ver essa página.",
 ...
 */
	...
	'exception:contact_admin' => 'Um erro irrecuperável ocorreu e foi reportado. Contate o administrador do site com as seguintes informações:',

	'actionundefined' => "A ação requisitada (%s) não foi definida no sistema.",
	'actionnotfound' => "O arquivo de execução %s não foi encontrado.",
	'actionloggedout' => "Desculpe, você não pode realizar essa ação enquanto não estiver logado.",
	'actionunauthorized' => 'Ação não autorizada para este usuário.',

	'InstallationException:SiteNotInstalled' => 'Incapaz de processar esse pedido. esse site '
		. ' não está configurado ou a base de dados está inoperante.',
	'InstallationException:MissingLibrary' => 'Incapaz de carregar %s',
